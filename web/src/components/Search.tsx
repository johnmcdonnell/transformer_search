...
function SearchResult(props: {'result': SearchProps['results'][0]}) {
    return (
        <ListItem key={props.result.result_number}>
...
class Search extends React.Component<{}, SearchProps> {
    ...
    search() {
        ...
        fetch(`https://johnmcdonnell-transformer-search-backend-fastapi-app.modal.run/search?query_string=${this.state.query}`)
